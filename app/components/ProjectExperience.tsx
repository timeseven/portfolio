...
import proj3 from "../../public/crawler.jpg";
  ...
  const projData = [
    {
      ...
      projectIntro:
        "A full stack posting and commenting system using NextJS, TanStack React Query between client and server, Prisma and PostgreSQL for creating and accessing database, and authentication with Next Auth.",
      githubLink: [{ name: "Github Repo", link: "https://github.com/timeseven/easy-post" }],
      demoLink: "https://easy-post-eosin.vercel.app/",
      skills: ["NextJS", "Tanstack", "Prisma", "PostgreSQL", "Next Auth"],
      projectImg: proj1,
    },
    {
      id: 2,
