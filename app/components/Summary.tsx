    ...
    <section className="min-h-screen">
      ...
      <div className="text-center p-10">
        ...
        <p className="text-xl max-w-xl mx-auto text-left py-5 leading-8  text-gray-800 dark:text-gray-100">
          I'm a full stack software developer focused on building scalable web and mobile applications. Embracing
          challenges and consistently eager to expand my skill set by learning new technologies.
        </p>
      </div>
